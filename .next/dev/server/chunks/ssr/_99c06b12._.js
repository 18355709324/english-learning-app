...
function LearningDashboard({ onStartLesson, currentCourseId }) {
    ...
    const [courseQuestionCounts, setCourseQuestionCounts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    // 加载学习统计数据
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadStats = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadCourseQuestionCounts = async ()=>{
            ...
            for (const course of allCourses){
                try {
                    // 查找对应的 Supabase 课程
                    const { data: courseRow } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("courses").select("id").eq("app_course_id", course.id).maybeSingle();
                    if (courseRow) {
                        // 统计该课程下的句子数量
                        const { count } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sentences").select("*", {
                            count: "exact",
                            head: true
                                ...
                                if (progress) {
                                    ...
                                    if (progress.totalQuestions !== actualQuestionCount && actualQuestionCount > 0) {
                                        ...
                                        if (progress.totalQuestions !== actualQuestionCount) {
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$learning$2d$progress$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCourseProgress"])(course.id, actualQuestionCount);
                                        }
                                    } else {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserNav$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserNav"], {}, void 0, false, {
                                        fileName: "[project]/components/learning-dashboard.tsx",
                                        lineNumber: 587,
                                        columnNumber: 13
                                    }, this)
...
function SentencePracticeApp({ courseId = "daily-conversation", onBack, onComplete }) {
    ...
    const [remoteQuestions, setRemoteQuestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loadingRemote, setLoadingRemote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [remoteError, setRemoteError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadFromSupabase = async ()=>{
            ...
            try {
                ...
                const { data: courseRow, error: courseError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("courses").select("id").eq("app_course_id", courseId).maybeSingle();
                if (courseError || !courseRow) {
                    setLoadingRemote(false);
                    return;
                }
                // 2. 加载该课程下的 sentences
                const { data: sentenceRows, error: sentenceError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("sentences").select("chinese, english, words").eq("course_id", courseRow.id).order("created_at", {
                    ascending: true
                });
                ...
                const mapped = sentenceRows.map((row, index)=>{
                    const english = String(row.english ?? "").trim();
                    const chinese = String(row.chinese ?? "").trim();
                    const wordsFromDb = Array.isArray(row.words) ? row.words.map((w)=>String(w ?? "").trim()).filter(Boolean) : [];
                    const words = wordsFromDb.length > 0 ? wordsFromDb : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$course$2d$manager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateWordsFromEnglish"])(english);
                    return {
                        id: index + 1,
                        chinese,
                        english,
...
//# sourceMappingURL=_99c06b12._.js.map