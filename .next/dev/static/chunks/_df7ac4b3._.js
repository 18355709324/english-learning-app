...
function AdminCoursesPage() {
    ...
    const [iconName, setIconName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("book-open");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminCoursesPage.useEffect": ()=>{
            const loadCourses = {
                "AdminCoursesPage.useEffect.loadCourses": async ()=>{
                    try {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").select("*").order("created_at", {
                            ascending: false
                        });
                        if (error) {
            ...
            }["AdminCoursesPage.useEffect.loadCourses"];
            loadCourses();
        }
    }["AdminCoursesPage.useEffect"], []);
    ...
    const handleSaveCourse = async ()=>{
        ...
        try {
            ...
            if (editingCourse) {
                ;
                ({ error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").update({
                    title: title.trim(),
                ...
                ;
                ({ error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").insert({
                    title: title.trim(),
                    description: description.trim() || null,
                    icon_name: iconName || null
                }));
    ...
    const handleDeleteCourse = async (id)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").delete().eq("id", id);
        if (error) {
    ...
    const handleSeedFromDefaults = async ()=>{
        ...
        setSeeding(true);
        try {
            const payload = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$courses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["courses"].map((c)=>({
                    title: c.title,
                    description: c.description,
                    icon_name: null,
                    total_lessons: c.questionCount ?? 0
                }));
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").insert(payload);
            if (error) {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("datalist", {
                                                            id: "icon-options",
                                                            children: ICON_OPTIONS.map((name)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: name
                                                                }, name, false, {
                                                                    fileName: "[project]/app/admin/courses/page.tsx",
                                                                    lineNumber: 228,
...
_s(AdminCoursesPage, "P96+z/AIoOY+f3kgYTJZ4fQ2uGM=", false, function() {
    return [
...
//# sourceMappingURL=_df7ac4b3._.js.map