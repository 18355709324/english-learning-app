...
"[project]/app/admin/courses/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminCourseDetailPage() {
    ...
    const [sentences, setSentences] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [sentencesLoading, setSentencesLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [saving, setSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [aiDialogOpen, setAiDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [aiItems, setAiItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [aiLevel, setAiLevel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("中等");
    ...
    const [editingSentence, setEditingSentence] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const autoWords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminCourseDetailPage.useMemo[autoWords]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$course$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateWordsFromEnglish"])(form.english)
    }["AdminCourseDetailPage.useMemo[autoWords]"], [
        form.english
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminCourseDetailPage.useEffect": ()=>{
            const load = {
                "AdminCourseDetailPage.useEffect.load": async ()=>{
                    setLoading(true);
                    const [{ data: courseData, error: courseError }, { data: lessonData, error: lessonError }] = await Promise.all([
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").select("id, title, description").eq("id", courseId).maybeSingle(),
                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("lessons").select("id, title").eq("course_id", courseId).order("order", {
                            ascending: true
                        })
                    ]);
            ...
            }["AdminCourseDetailPage.useEffect.load"];
            if (courseId) {
                load();
            }
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminCourseDetailPage.useEffect": ()=>{
            const loadSentences = {
                "AdminCourseDetailPage.useEffect.loadSentences": async ()=>{
                    if (!courseId) return;
                    setSentencesLoading(true);
                    let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").select("id, chinese, english, words, lesson_id").eq("course_id", courseId);
                    if (selectedLessonId) {
            ...
            }["AdminCourseDetailPage.useEffect.loadSentences"];
            loadSentences();
        }
    }["AdminCourseDetailPage.useEffect"], [
        courseId,
    ...
    const handleFormChange = (field, value)=>{
        setForm((prev)=>({
                ...
                ...field === "english" && (prev.wordsInput === "" || prev.wordsInput === autoWords.join(" ")) ? {
                    wordsInput: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$course$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateWordsFromEnglish"])(value).join(" ")
                } : {}
            }));
    };
    const handleSaveSentence = async ()=>{
        ...
        let error = null;
        if (editingSentence) {
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").update(payload).eq("id", editingSentence.id);
            error = updateError;
        } else {
            const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").insert(payload);
            error = insertError;
        }
        setSaving(false);
        if (error) {
    ...
    const handleDeleteSentence = async (sentence)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").delete().eq("id", sentence.id);
        if (error) {
    ...
    const handleSaveSelectedAiItems = async ()=>{
        ...
        try {
            ...
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").select("id, english").eq("course_id", courseId);
            if (selectedLessonId) {
                query = query.eq("lesson_id", selectedLessonId);
            }
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").insert(payload);
            if (error) {
            ...
            // 重新加载句子列表
            let reloadQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("sentences").select("id, chinese, english, words, lesson_id").eq("course_id", courseId);
            if (selectedLessonId) {
            ...
            children: [
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                autoWords.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        sentencesLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 561,
                            columnNumber: 13
                        }, this) : sentences.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "py-10 text-center text-sm text-slate-500",
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                        ...
                        children: [
                            ...
                            aiLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 627,
                                columnNumber: 15
                            }, this) : aiItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "py-10 text-center text-sm text-slate-500",
                                children: "暂无数据，请稍后重试。"
                            }, void 0, false, {
                                fileName: "[project]/app/admin/courses/[id]/page.tsx",
...
_s(AdminCourseDetailPage, "58Or2NnntzhiLpWnBWV7WgCAY6I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = AdminCourseDetailPage;
var _c;
__turbopack_context__.k.register(_c, "AdminCourseDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_7daaa1e2._.js.map