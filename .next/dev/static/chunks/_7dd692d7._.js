...
function useProgress() {
    ...
    const loadProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[loadProgress]": async ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
                // 1. 先从 LocalStorage 恢复进度，避免白屏
                ...
                // 2. 如果用户已登录，从 Supabase 拉取云端进度并合并
                ...
                if (session?.user) {
                    ...
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_progress").select("course_id, is_completed").eq("user_id", session.user.id).eq("is_completed", true);
                    if (error) {
                        console.error("Failed to load user_progress from Supabase:", error);
                    } else if (data) {
                        const cloudCompletedIds = data.map({
                            "useProgress.useCallback[loadProgress].cloudCompletedIds": (row)=>row.course_id
                        }["useProgress.useCallback[loadProgress].cloudCompletedIds"]);
    ...
    }["useProgress.useCallback[loadProgress]"], [
        progress.completedLessonIds,
    ...
    const saveProgress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[saveProgress]": (newProgress)=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            try {
    ...
    }["useProgress.useCallback[saveProgress]"], []);
    // 标记课程为已完成（本地 + 云端）
    const markLessonCompleted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[markLessonCompleted]": async (lessonId)=>{
    ...
    }["useProgress.useCallback[markLessonCompleted]"], [
        progress,
        saveProgress,
        userId
    ]);
    // 设置当前学习的课程
    const setCurrentLesson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[setCurrentLesson]": (lessonId)=>{
            const newProgress = {
                ...progress,
    ...
    }["useProgress.useCallback[setCurrentLesson]"], [
        progress,
        saveProgress
    ]);
    // 检查课程是否已完成
    const isLessonCompleted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[isLessonCompleted]": (lessonId)=>{
            return progress.completedLessonIds.includes(lessonId);
        }
    }["useProgress.useCallback[isLessonCompleted]"], [
        progress.completedLessonIds
    ]);
    // 获取当前学习的课程ID
    const getCurrentLessonId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[getCurrentLessonId]": ()=>{
    ...
    // 获取已完成的课程数量
    const getCompletedCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProgress.useCallback[getCompletedCount]": ()=>{
...
_s(useProgress, "O39eIpjgh8BC+xbiFQGqB2c+2QM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Home() {
    ...
    const { markLessonCompleted } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$progress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProgress"])();
...
_s(Home, "5YVV0zuXG7PyYG4Jjax8NNuq4nk=", false, function() {
    return [
...
//# sourceMappingURL=_7dd692d7._.js.map