...
function AdminCoursesPage() {
    ...
    const handleCreateCourse = async ()=>{
        ...
        setSaving(true);
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("courses").insert({
                title: title.trim(),
...
_s(AdminCoursesPage, "u0m5qgKJ4UPdq31fDQHf54Q/P7g=", false, function() {
    return [
...
//# sourceMappingURL=_d7e465c6._.js.map